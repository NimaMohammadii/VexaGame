...
const HOME_MARKUP_STYLES = [
  ...
  '.home-ticket-drawer-head{display:flex!important;align-items:center!important;justify-content:space-between!important;gap:8px!important}.home-ticket-drawer-head strong{font-size:16px!important;font-weight:950!important}',
...
(function(){
  ...
  function bind(sec){
    ...
    document.addEventListener('click',function(e){var t=e.target,close=t&&t.closest&&t.closest('#homeTicketDrawerClose');if(close){e.preventDefault();setDrawer(false,sec);return}if(t&&t.id==='homeTicketDrawerBackdrop'){e.preventDefault();setDrawer(false,sec)}},true);
  }
