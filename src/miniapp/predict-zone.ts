...
(function(){
  ...
  ready(function(){
    ...
    function formatPresetWin(v){var n=Number(v);if(!isFinite(n)||n<=0)return'—';return n.toLocaleString('en-US',{minimumFractionDigits:0,maximumFractionDigits:n>=100?1:2})}
