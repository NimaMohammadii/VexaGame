...
(function(){
  ...
  var sectionTitles={home:'Lucky Zone',predictzone:'Predict',results:'Bot Control',playzone:'Play Hub',mines:'Mines',plinko:'Plinko',crash:'Crash',wheel:'Wheel',dice:'Dice',tower:'Dragon Tower',slot:'Slot',coinflip:'Pump',ghostrun:'Ghost Run',shellgame:'Shell Game',hilo:'Chicken Cross'};
