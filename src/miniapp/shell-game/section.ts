...
<section id="shellgame" class="view shell-game-view" aria-label="Shell Game">
  <style>
    ...
    html body:has(#shellgame.active.has-admin-background) .app::before,html body:has(#shellgame.active.has-admin-background) .app::after{display:none!important;content:none!important;background:none!important;background-image:none!important}
    ...
    html body:has(#shellgame.active.has-admin-background) #shellgame.has-admin-background::before{content:''!important;display:block!important;position:fixed!important;inset:0!important;width:100vw!important;height:100dvh!important;z-index:-1!important;pointer-events:none!important;background-color:#030202!important;background-image:var(--admin-section-background-image)!important;background-size:cover!important;background-position:center top!important;background-repeat:no-repeat!important}
