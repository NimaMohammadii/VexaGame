  ...
  <div class="shell-game-wrap">
    ...
    <div class="shell-game-controls">
      ...
      <div class="shell-bet-row">
        ...
        <button class="shell-bet-value" type="button" data-shell-bet><img src="/app/api/uploaded-image/ton-icon.png" alt="GRAM"/><span>1</span><small>GRAM</small></button>
