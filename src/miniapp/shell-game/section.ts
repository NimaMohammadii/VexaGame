...
<section id="shellgame" class="view shell-game-view" aria-label="Shell Game">
  <style>
    ...
    .shell-cup{position:absolute;left:50%;bottom:170px;width:80%;height:auto;object-fit:contain;transform:translateX(-50%);filter:none;pointer-events:none}
    .shell-cup-number{position:absolute;z-index:2;left:50%;bottom:186px;transform:translateX(-50%);font-family:Georgia,'Times New Roman',serif;font-size:23px;font-weight:700;color:#f3d5b7;text-shadow:0 2px 5px #000;pointer-events:none}
