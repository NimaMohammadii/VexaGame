export const WALLET_SECTION = `<div id="wallet" class="wallet-sheet" aria-hidden="true">
  <style>
    ...
    #wallet .wallet-sheet-panel{position:absolute!important;left:0!important;right:0!important;bottom:0!important;width:min(100%,560px)!important;height:calc(252px + env(safe-area-inset-bottom))!important;margin:0 auto!important;padding:18px 14px calc(18px + env(safe-area-inset-bottom))!important;box-sizing:border-box!important;border:1px solid rgba(126,31,55,.20)!important;border-bottom:0!important;border-radius:30px 30px 0 0!important;background:#090506!important;background-image:none!important;box-shadow:0 -22px 56px rgba(0,0,0,.46)!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;transform:translateY(calc(100% + 28px))!important;overflow:hidden!important;will-change:transform,height!important;transition:transform .42s cubic-bezier(.16,1,.3,1),height .32s cubic-bezier(.16,1,.3,1)!important}
    #wallet .wallet-sheet-panel:before{display:block!important;content:""!important;position:absolute!important;top:8px!important;left:50%!important;width:34px!important;height:4px!important;border-radius:999px!important;background:rgba(126,31,55,.42)!important;transform:translateX(-50%)!important;pointer-events:none!important}
    #wallet.open .wallet-sheet-panel{transform:translateY(0)!important}
    body.wallet-open.deposit-open #wallet .wallet-sheet-panel{height:min(420px,calc(100vh - 16px))!important}
    body.wallet-open.withdraw-open #wallet .wallet-sheet-panel{height:min(452px,calc(100vh - 16px))!important}
    ...
    body.wallet-open.deposit-open #depositSheet.deposit-sheet .deposit-close,body.wallet-open.withdraw-open #withdrawSheet.deposit-sheet .deposit-close{width:44px!important;height:44px!important;min-width:44px!important;padding:0!important;border:1px solid rgba(126,31,55,.16)!important;border-radius:15px!important;background:#10080b!important;color:#fff!important;display:grid!important;place-items:center!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}
    ...
    body.wallet-open.deposit-open #depositSheet .deposit-amount-row,body.wallet-open.withdraw-open #withdrawSheet .deposit-amount-row{width:100%!important;height:48px!important;min-height:48px!important;border:1px solid rgba(126,31,55,.16)!important;border-radius:16px!important;background:#10080b!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}
    body.wallet-open.deposit-open #depositSheet .deposit-pay-button,body.wallet-open.withdraw-open #withdrawSheet .deposit-pay-button{width:min(100%,340px)!important;max-width:340px!important;margin-left:auto!important;margin-right:auto!important;height:46px!important;min-height:46px!important;border:0!important;border-radius:16px!important;background:#591128!important;color:#fff!important;font-size:13px!important;font-weight:900!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}
    body.wallet-open.deposit-open #depositSheet .deposit-pay-button:active,body.wallet-open.withdraw-open #withdrawSheet .deposit-pay-button:active{background:#681632!important;transform:scale(.992)!important}
    ...
    body.wallet-open.deposit-open #depositSheet .deposit-method-option{min-height:68px!important;border:1px solid rgba(126,31,55,.14)!important;border-radius:18px!important;padding:10px 12px!important;background:#0f080a!important;background-image:none!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}
    body.wallet-open.deposit-open #depositSheet .deposit-method-option:active{background:#140a0e!important}
    ...
    body.wallet-open.deposit-open #depositSheet .wallet-withdraw-link svg{width:17px!important;height:17px!important;display:block!important;color:#a93657!important;flex:0 0 auto!important}
...
.deposit-sheet{position:fixed;inset:0;z-index:120;display:none}.deposit-sheet.open{display:block}.deposit-backdrop{position:absolute;inset:0;background:rgba(0,0,0,.58);backdrop-filter:none;-webkit-backdrop-filter:none}.deposit-panel{position:absolute;left:16px;right:16px;bottom:calc(14px + env(safe-area-inset-bottom));max-width:528px;margin:0 auto;padding:16px;border-radius:28px;background:#090506;animation:depositIn .28s cubic-bezier(.2,.8,.2,1)}.deposit-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.deposit-head h3{margin:0;font-size:24px;font-weight:780;letter-spacing:-.055em}.deposit-close{width:38px;height:38px;border-radius:14px;background:#10080b;color:#fff;font-size:24px}.deposit-copy{color:rgba(255,255,255,.58);font-size:12.5px;line-height:1.45;margin:12px 0;font-weight:470}.deposit-presets{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.deposit-presets button{height:70px;border-radius:18px;border:1px solid rgba(126,31,55,.14);background:#0f080a;color:#fff}.deposit-presets b{display:block;font-size:20px;font-weight:780}.deposit-presets span{display:block;color:rgba(255,255,255,.52);font-size:11px}.deposit-custom{display:grid;grid-template-columns:1fr 86px;gap:8px;margin-top:9px}.deposit-custom input{height:50px;border-radius:16px;background:#10080b;border-color:rgba(126,31,55,.16)}.deposit-custom button{border-radius:16px;background:#591128;color:#fff;font-weight:760}.deposit-status{min-height:18px;margin:10px 2px 0;color:rgba(255,255,255,.56);font-size:11.5px}@keyframes depositIn{from{opacity:0;transform:translateY(28px) scale(.97)}to{opacity:1;transform:translateY(0) scale(1)}}
...
.deposit-panel{
  ...
  border:1px solid rgba(126,31,55,.16)!important;
...
#depositSheet .deposit-credit-icon,#withdrawSheet .withdraw-title-icon{
  ...
  overflow:hidden!important;
  background:rgba(89,17,40,.20)!important;
  color:#fff!important;
}
...
body > #transactionsSheet .transactions-title-icon,#transactionsSheet .transactions-title-icon{width:34px!important;height:34px!important;border-radius:13px!important;display:grid!important;place-items:center!important;background:rgba(89,17,40,.20)!important;color:#fff!important;flex:0 0 auto!important;filter:none!important}
...
body > #transactionsSheet .deposit-close,#transactionsSheet .deposit-close{width:40px!important;height:40px!important;min-width:40px!important;padding:0!important;border:1px solid rgba(126,31,55,.16)!important;border-radius:14px!important;background:#10080b!important;color:#fff!important;display:grid!important;place-items:center!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}
...
body > #transactionsSheet .transaction-row,#transactionsSheet .transaction-row{display:grid!important;grid-template-columns:40px minmax(0,1fr) auto!important;gap:10px!important;align-items:center!important;border:1px solid rgba(126,31,55,.12)!important;border-radius:17px!important;background:#0f080a!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;padding:11px 11px!important;animation:depositItemIn .36s ease both!important}
body > #transactionsSheet .transaction-icon,#transactionsSheet .transaction-icon{width:40px!important;height:40px!important;border-radius:14px!important;display:grid!important;place-items:center!important;color:#fff!important;background:rgba(89,17,40,.18)!important}
...
body > #transactionsSheet .transactions-empty,#transactionsSheet .transactions-empty{text-align:center!important;color:rgba(255,255,255,.58)!important;font-size:13px!important;font-weight:720!important;padding:24px 8px!important;border:1px solid rgba(126,31,55,.12)!important;border-radius:17px!important;background:#0f080a!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}
`;
