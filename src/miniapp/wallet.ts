export const WALLET_SECTION = `<div id="wallet" class="wallet-sheet" aria-hidden="true">
  <style>
    ...
    #wallet .wallet-sheet-backdrop{position:absolute!important;inset:0!important;background:rgba(0,0,0,.48)!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;opacity:0!important;transition:opacity .26s ease!important}
    #wallet.open .wallet-sheet-backdrop{opacity:1!important}
    #wallet .wallet-sheet-panel{position:absolute!important;left:0!important;right:0!important;bottom:0!important;width:min(100%,560px)!important;height:calc(252px + env(safe-area-inset-bottom))!important;margin:0 auto!important;padding:10px 14px calc(18px + env(safe-area-inset-bottom))!important;box-sizing:border-box!important;border:1px solid rgba(255,255,255,.06)!important;border-bottom:0!important;border-radius:28px 28px 0 0!important;background:#141416!important;background-image:none!important;box-shadow:0 -18px 48px rgba(0,0,0,.38)!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;transform:translateY(calc(100% + 28px))!important;overflow:hidden!important;will-change:transform,height!important;transition:transform .42s cubic-bezier(.16,1,.3,1),height .32s cubic-bezier(.16,1,.3,1)!important}
    #wallet .wallet-sheet-panel:before{display:none!important;content:none!important}
    ...
    body.wallet-open.deposit-open #depositSheet.deposit-sheet .deposit-close,body.wallet-open.withdraw-open #withdrawSheet.deposit-sheet .deposit-close{width:46px!important;height:46px!important;min-width:46px!important;padding:0!important;border:1px solid rgba(255,255,255,.06)!important;border-radius:28px!important;background:#202023!important;color:#fff!important;display:grid!important;place-items:center!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}
    ...
    body.wallet-open.deposit-open #depositSheet .deposit-amount-row,body.wallet-open.withdraw-open #withdrawSheet .deposit-amount-row{width:100%!important;height:44px!important;min-height:44px!important;border:1px solid rgba(255,255,255,.055)!important;border-radius:18px!important;background:#1b1b1e!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}
    body.wallet-open.deposit-open #depositSheet .deposit-pay-button,body.wallet-open.withdraw-open #withdrawSheet .deposit-pay-button{width:min(100%,340px)!important;max-width:340px!important;margin-left:auto!important;margin-right:auto!important;height:44px!important;min-height:44px!important;border:0!important;border-radius:18px!important;background:linear-gradient(135deg,#68152f,#3d0b1d)!important;color:#fff!important;font-size:13px!important;font-weight:950!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}
    ...
    body.wallet-open.deposit-open #depositSheet .deposit-method-option{min-height:72px!important;border:1px solid rgba(255,255,255,.055)!important;border-radius:24px!important;padding:12px 14px!important;background:#1b1b1e!important;background-image:none!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}
