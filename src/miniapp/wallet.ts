...
(function(){
  ...
  function ensureWithdrawMethods(){var sheet=q('withdrawSheet');if(!sheet)return;var style=q('vexa-withdraw-method-style');if(!style){style=document.createElement('style');style.id='vexa-withdraw-method-style';style.textContent='#withdrawSheet .withdraw-method-grid{width:min(100%,340px)!important;margin:0 auto 12px!important;display:grid!important;grid-template-columns:1fr 1fr!important;gap:6px!important}.withdraw-method-button{appearance:none!important;-webkit-appearance:none!important;min-height:42px!important;border:0!important;border-radius:13px!important;padding:7px 10px!important;background:rgba(255,255,255,.025)!important;color:rgba(255,255,255,.42)!important;display:grid!important;place-items:center!important;gap:2px!important;box-shadow:none!important;transform:none!important;-webkit-tap-highlight-color:transparent!important;transition:background .22s ease,color .22s ease,opacity .22s ease,transform .12s ease!important}.withdraw-method-button strong{font-size:13px!important;font-weight:780!important;line-height:1!important;letter-spacing:-.01em!important;color:inherit!important}.withdraw-method-button span{font-size:9.5px!important;font-weight:650!important;color:rgba(255,255,255,.28)!important;transition:color .22s ease!important}.withdraw-method-button.selected{background:rgba(255,255,255,.075)!important;color:rgba(255,255,255,.96)!important;box-shadow:none!important;transform:none!important}.withdraw-method-button.selected span{color:rgba(255,255,255,.56)!important}.withdraw-method-button:active{transform:scale(.985)!important;opacity:.82!important}#withdrawSheet .deposit-ton-equivalent{white-space:nowrap!important;color:rgba(255,255,255,.72)!important;font-size:12px!important;font-weight:800!important}';document.head.appendChild(style)}var copy=sheet.querySelector('.deposit-copy');if(!q('withdrawMethodGrid')&&copy){var grid=document.createElement('div');grid.id='withdrawMethodGrid';grid.className='withdraw-method-grid';grid.innerHTML='<button class="withdraw-method-button selected" type="button" data-action="select-withdraw-method" data-withdraw-method="gram"><strong>GRAM</strong><span>Native wallet</span></button><button class="withdraw-method-button" type="button" data-action="select-withdraw-method" data-withdraw-method="usdt-bep20"><strong>USDT</strong><span>BEP20</span></button>';copy.insertAdjacentElement('afterend',grid)}}
